...
export default function NavBar() {
  ...
  return (
    <Box>
      <Flex
        bg={useColorModeValue('#E9F1FA', 'gray.800')}
        color={useColorModeValue('#00ABE4', 'white')}
        minH={'60px'} // Consistent height for both themes
        py={{ base: 2 }}
        px={{ base: 4 }}
        borderBottom={1}
        borderStyle={'solid'}
      ...
      >
        ...
        <Flex flex={{ base: 1 }} justify={{ base: 'center', md: 'start' }}>
          <Box>
            <Avatar as='a' size='lg' name='logo' src='/logo.jpeg' href='/' />
          </Box>
...
const MobileNav = () => {
  return (
    <Stack bg={useColorModeValue('#E9F1FA', 'gray.800')} p={4} display={{ md: 'none' }}>
      {NAV_ITEMS.map((navItem) => (
